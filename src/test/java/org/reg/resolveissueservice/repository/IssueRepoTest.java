...
public class IssueRepoTest {
    ...
    public void testSaveIssue() {
        // Given
        Issue issue = new Issue(1L, "Sample Issue", new Date(), "vishu", "Open");
    ...
    public void testFindIssueById() {
        // Given
        Issue issue = new Issue(1L, "Sample Issue", new Date(), "aryan", "Open");
    ...
    public void testFindAllIssues() {
        ...
        when(issueRepo.findAll()).thenReturn(List.of(
                new Issue(1L, "Issue 1", new Date(), "rewa", "Open"),
                new Issue(2L, "Issue 2", new Date(), "sharon", "In Progress")
        ));
